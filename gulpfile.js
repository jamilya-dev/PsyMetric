...
gulp.task(
  "css:dev",
  gulp.series("css:clean", lazyQuire(require, "./gulp/core/recipes/css/dev")),
);
gulp.task(
  "css:prod",
  gulp.series("css:clean", lazyQuire(require, "./gulp/core/recipes/css/prod")),
);
gulp.task(
  "css:watch",
  gulp.series("css:dev", lazyQuire(require, "./gulp/core/recipes/css/watch")),
);
